...
.picture-search-form :deep(.ant-form-item-label > label) {
...
.picture-search-form :deep(.ant-select:hover .ant-select-selector),
.picture-search-form :deep(.ant-picker:hover) {
  border-color: var(--yu-primary);
}

.picture-search-form :deep(.ant-input::placeholder),
.picture-search-form :deep(.ant-select-selection-placeholder) {
