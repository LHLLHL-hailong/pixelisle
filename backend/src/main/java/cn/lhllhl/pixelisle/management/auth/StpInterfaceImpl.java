...
import static cn.lhllhl.pixelisle.constant.UserConstant.USER_LOGIN_STATE;
...
public class StpInterfaceImpl implements StpInterface {
    ...
    @Autowired
    private SpaceUserAuthManger spaceUserAuthManager;
    ...
    private boolean isAllFieldsNull(SpaceUserAuthContext authContext) {
        ...
        return ObjUtil.isEmpty(authContext.getPictureId())
                && ObjUtil.isEmpty(authContext.getSpaceId())
                && ObjUtil.isEmpty(authContext.getSpaceUserId());
    }
